...
class Dianzishu_Spider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for i in chapter_list:
            print(i)
            item['chapter'].append(dict(chapter_name=i[1],chapter_url='{}/{}/{}'.format(domain,sub_link,i[0]),chapter_content=[]))
